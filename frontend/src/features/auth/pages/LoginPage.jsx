        ...
        <div className="md:w-5/12 bg-primary-900 p-10 text-white flex flex-col justify-between relative overflow-hidden group">
          ...
          <div className="relative z-10 mt-12 mb-12 animate-slide-right delay-200">
            ...
            <p className="text-blue-100 text-lg font-light leading-relaxed">
              Sign in to manage your campus operations, book facilities, and raise support tickets efficiently.
            </p>
          </div>
        ...
        <div className="md:w-7/12 p-10 sm:p-14 flex flex-col justify-center bg-white">
          <div className="w-full max-w-md mx-auto animate-slide-left delay-400">
            ...
            <form className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <a href="#" className="text-sm font-semibold text-primary-900 hover:text-primary-800 transition-colors">
                    Forgot password?
                  </a>
                </div>
                <div className="relative">
            ...
            <p className="mt-8 text-center text-sm text-slate-600">
              ...
              <Link to="/signup" className="font-semibold text-primary-900 hover:text-primary-800 transition-colors">
                Sign up
              </Link>
            </p>
            <p className="mt-2 text-center text-sm text-slate-600">
              Go to{' '}
              <Link to="/user/dashboard" className="font-semibold text-primary-900 hover:text-primary-800 transition-colors">
                User Dashboard
              </Link>{' '}
              /{' '}
              <Link to="/admin/dashboard" className="font-semibold text-primary-900 hover:text-primary-800 transition-colors">
                Admin Dashboard
              </Link>
            </p>
          </div>
